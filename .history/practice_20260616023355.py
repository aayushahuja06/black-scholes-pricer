...
future_prices = np.random.normal(loc=105, scale=12, size=10)
# Task 8:
...
print(np.maximum(future_prices - strike, 0))
# Task 10:
# Print the average of the call payoffs from future_prices.
print(np.mean(np.maximum(future_prices - strike, 0)))
# Bonus task:
# Print how many values in future_prices finish above strike.
print("Number of future prices above strike:", np.sum(future_prices > strike))