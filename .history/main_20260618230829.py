...
print(bs.implied_volatility(11.00))  # higher market price should imply higher vol
print(bs.implied_volatility(8.00))   # lower market price should imply lower vol